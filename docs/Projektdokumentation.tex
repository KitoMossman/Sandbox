...
\begin{itemize}
	...
	\item \textbf{Docker-Terminal:} Leitet den Zugriff in die isolierte Umgebung des LXC-Containers \texttt{docker-sandbox} weiter (siehe vHost-Konfiguration in Anlage \ref{sda3:ttyd-docker}).
\end{itemize}
\bigskip
...
\begin{itemize}
	...
	\item \textbf{docker-sandbox.ma.ki}: Zeigt auf \texttt{192.168.100.22} (Direktzugriff auf die Container-Infrastruktur).
...
Nach dem Neustart befindet sich das System in der \texttt{recovery-sandbox}. Da das Hauptsystem auf \texttt{sda3} nun nicht aktiv ist, kann ein bitgenaues Abbild erstellt werden. Hierzu wird das Werkzeug \textbf{partclone} in Kombination mit \textbf{gzip} zur Kompression verwendet.\\
...
\begin{itemize}
	\item \textbf{Durchführung:} Löschen des gesamten Verzeichnisbaums eines aktiven Site-Users unter \texttt{/home/[user]/logs/}.
